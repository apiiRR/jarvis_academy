...
class __Mustache_332c1660f3a8a3cf481eb8b66b6a210b extends Mustache_Template
{
...
';
        $buffer .= $indent . '</div>
';
        $buffer .= $indent . '<footer id="page-footer" class="p-y-1" style="background-color: #8E0C11;">
';
        $buffer .= $indent . '  <div class="container-fluid">
';
...
';
        $buffer .= $indent . '          <p>Modified by Jarvis Developer</p>
';
        $buffer .= $indent . '      </div>
';
        $buffer .= $indent . '
...
';
        $buffer .= $indent . '          <p>Made with <i class="text-white fa fa-heart"></i> and <i class="text-white fa fa-heart"></i></p>
';
        $buffer .= $indent . '      </div>
';
        $buffer .= $indent . '  </div>
